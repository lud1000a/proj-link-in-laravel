...
<br>
    @if(isset($n))
        <form action='controllers/add-link.php' method='post'>
            @for($x=1; $x<=$n; $x++)
                <div class="d-inline-flex p-2 bd-highlight">
                    <div class="shadow-lg p-3 mb-5 bg-white rounded">
                        <div class="itens position-relative">
                                <hr><br>
                                <span style="font-size: 18px;" class="position-absolute top-0 start-50 translate-middle badge rounded-pill bg-primary"><?= $x; ?></span>
